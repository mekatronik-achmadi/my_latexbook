...
\begin{document}
	...
	Linux adalah \textit{kernel} sistem operasi komputer yang dibuat di tahun 1991 oleh mahasiswa Finlandia, Linus Benedict Torvald.
	...
	\begin{itemize}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s1}
			\caption{Pilih OS}
		\end{figure}
	...
	\begin{itemize}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s3}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s4}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s5}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s6}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s7}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\linewidth]{images/vbox_installinux/s8}
	...
	Secara default, \textit{shell} yang digunakan adalah \textbf{zsh}.
	Untuk mempermudah, maka lebih baik masuk ke \textit{shell} \textbf{bash}.
	Ketikkan perintah:
	\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
bash
	\end{minted}
	Lalu untuk menjalankan perintah, tekan keyboard Enter (\keys{\return}).	
	Untuk mengecek shell yang digunakan, perintahnya:
	\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
echo $0
	\end{minted}
...
shutdown now
	...
	Dalam sistem operasi berbasis UNIX (Linux, BSD, Darwin, MacOS, etc), seluruh directory (folder) dimulai dari alamat "\textbf{/}".
...
nano namafile.txt
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.6\linewidth]{images/nano}
