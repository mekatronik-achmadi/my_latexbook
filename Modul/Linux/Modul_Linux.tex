...
ls -l /var/cache/pacman/pkg/
	...
	\begin{itemize}
		...
		\begin{minted}[frame=lines,fontsize=\footnotesize]{md}
...
.ICEauthority       .pki                         .zekr
		...
		Berikut beberapa contohnya:
		\begin{itemize}
			\item Sebelum belajar pindah-pindah directory, ada baiknya mengetahui cara dimana posisi sekarang.
			Perintahnya:
			\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
pwd
			\end{minted}
...
/usr/lib
		...
		\item Membuat/Menghapus/Menyalin Directory
		\begin{itemize}
...
ls -l coba_bikin
			...
			\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
mkdir coba_baru
cp -r coba_bikin/bikin_lagi
ls -l coba_baru
			\end{minted}
			Contoh menyalin semua isi sekaligus
			\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
cp -r coba_bikin/*
ls -l coba_baru
			\end{minted}
...
nano namafile.txt
		...
		\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
mkdir folderbaru
cp -f namafile.txt folderbaru/
		\end{minted}
		
		\item Mengganti nama file text.
		\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
mv -vf namafile.txt namabaru.txt
		\end{minted}
		
		Perintah \textbf{mv} juga dapat untuk memindahkan file
		\begin{minted}[frame=lines,fontsize=\footnotesize]{bash}
mv -vf namabaru.txt folderbaru/namabaru.txt
		\end{minted}
