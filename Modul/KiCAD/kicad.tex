...
kicad
	...
	\begin{enumerate}[label=\textbf{\arabic*}.]
		...
		\item Mode pointer default (dapat juga dengan menekan \textit{escape} pada keyboard)
	...
	Agar tidak membingungkan proses tes ERC (Electric Rule Check), maka pin ESP32 yang digunakan perlu ditandai sebagai Not-Connected.
	Klik menu \textit{Place -> Add No Connect Flag} atau klik \textbf{No:12}.\\
	...
	\textbf{TIPS:} Global Label dapat juga dilakukan \textit{Duplicate} sebagaimana komponen.

	\subsubsection{Tombol Reset dan Flash}

	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.35\textwidth]{images/sch/sch_18}
		\caption{Reset and Flash}
	\end{figure}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.35\textwidth]{images/sch/sch_19}
		\caption{LED dan Decouple}
	\end{figure}

	\textbf{TIPS:} Anda dapat melakukan \textit{Save} dan \textit{Annotate Schematic} sesering yang anda suka.
