...
kicad
	...
	\textbf{TIPS:} Anda dapat melakukan \textbf{Save} (menu \menu[,]{File,Save} atau \keys[,]{ctrl,s}) dan \textbf{Annotate Schematic} sesering yang anda suka.
	...
	\textbf{TIPS:} Untuk kebutuhan kompatibilitas format Gerber, anda dapat menggunakan format RX-274/X dengan membuang centang \menu{Use extended X2 format}
	dan membuang makro aperture dengan mencentang \menu{Disable aperture macros}.
	...
	\begin{table}[h!]
		\begin{center}
			\begin{tabular}{|l|l|l|}
				...
				\midrule
				PCBgogo & China & \url{https://www.pcbgogo.com/} \\
				\midrule
				Allpcb & China & \url{https://www.allpcb.com/} \\
				\midrule
