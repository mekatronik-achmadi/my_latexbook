...
kicad
	...
	\begin{enumerate}[label=\textbf{\arabic*}.]
		...
		\item Mode menggambar garis tanpa sinyal
		\item Mode menambahkan text bebas
	\end{enumerate}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[width=0.6\textwidth]{images/sch/sch_4}
		\caption{Sinyal Properties}
	\end{figure}

	Isi nama sinyal dengan \textbf{TX0} dan klik \textit{OK}.
	Kemudian tempatkan label sinyal pada IO1 seperti di bawah ini:
	...
	\begin{itemize}
		...
		\item \textbf{f}. Flip atau menukar orientas objek.
	\end{itemize}
