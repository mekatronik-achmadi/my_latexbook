...
print(r)
	...
	Untuk lebih memperdalam pemahaman, berikut panduan ringkas menggunakan template \LaTeX{} yang tersedia untuk beberapa publikasi

	\section{Journal of the Acoustic Society of America (JASA)}
	...
	\subsection{Memilah/Mengumpulkan}
...
$> pdflatex -shell-escape -synctex=1 -interaction=nonstopmode reprintsample.tex
	...
	dari berkas dokumen template ke dokumen yang dikerjakan, sehingga ketimbang melakukan editing ke dokumen template langsung.
	Dengan demikian dokumen template digunakan sebagai contoh atau acuan.
	...
	\subsubsection{Kerangka Dokumen}
...
\end{document}
	...
	Berikut contoh konten judul yang akan ditampilkan oleh tag maketitle
...
\end{abstract}
	...
	\href{https://github.com/mekatronik-achmadi/my_latexbook/blob/master/Modul/LaTex/files/orca.bib}{disini}.
...
$> pdflatex -shell-escape -synctex=1 -interaction=nonstopmode paperorca.tex
	...
	\subsubsection{Konten Selanjutnya}
