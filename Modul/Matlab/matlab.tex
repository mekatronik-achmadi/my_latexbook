...
ans =
	...
	\begin{enumerate}
		...
		\item \textbf{Inline}. Fungsi jenis ini menggunakan perintah \textbf{inline()} untuk deklarasi fungsi.
		Topik ini dibahas pada bagian selanjutnya.
		
		\item \textbf{Operator @}. Fungsi jenis ini menggunakan operator @ untuk deklarasi fungsi secara anonim.
		Topik ini dibahas pada bagian selanjutnya.
